"""
.. module:: undirected_random_walk
   :synopsis: Defines several functions for performing a random walk on
            a undirected hypergraph and finding its corresponding stationary
            distribution.
"""
import numpy as np
...
def _compute_transition_matrix(H,
    ...
    D_v = umat.get_vertex_degree_matrix(M_out, W)
    D_e = umat.get_hyperedge_degree_matrix(M_in)
